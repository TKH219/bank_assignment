      ...
      children: [
        Visibility(
            ...
            child: Padding(
              ...
              child: Text(
                widget.label != null
                    ? '${widget.isLabelUpperCase ? widget.label?.toUpperCase() : widget.label}${widget.isRequired ? '*' : ''}'
                    : '',
              ...
              builder: (context, value, child) {
                return TextFormField(
                  style: appTheme().textTheme.bodyLarge!.copyWith(
                        color: widget.enable ? AppColor.textColor : AppColor.grey,
                        fontSize: 14.sp,
                      ),
                  ...
                  decoration: InputDecoration(
                    ...
                    fillColor: widget.enable
                        ? widget.backgroundColor ??
                            (!widget.borderEnable ? AppColor.textFieldBackground : AppColor.textFieldBackground)
                        : Colors.transparent,
                    enabledBorder: widget.borderEnable
                        ? textFieldBorder(
                            borderRadius: widget.borderRadius ?? 5.r,
                    ...
                    disabledBorder: widget.borderEnable
                        ? textFieldBorder(
                            borderRadius: widget.borderRadius ?? 5.r,
                            borderColor: widget.borderColor,
                          )
                    ...
                    errorStyle: appTheme().textTheme.bodyLarge!.copyWith(
                          fontSize: 10.spMin,
                          color: AppColor.red,
                        ),
...
DropDownDecoratorProps dropdownDecoration(
    {String? label, bool borderEnable = true, EdgeInsetsGeometry? padding, String? hint, double? fontSize}) {
